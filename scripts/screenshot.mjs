...
import { readFileSync, statSync, mkdirSync, readdirSync, existsSync } from 'node:fs';
...
function findChrome() {
  ...
  if (!found) {
    console.error('Nie znaleziono przeglądarki. Ustaw zmienną PUPPETEER_EXECUTABLE_PATH na ścieżkę do Chrome/Edge.');
    process.exit(1);
  }
  return found;
}
