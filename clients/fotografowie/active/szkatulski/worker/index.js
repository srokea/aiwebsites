 ...
 *   GET    /api/settings               → { hero_desktop?, hero_mobile?, ... }
 *
...
import { getSettings, uploadHeroImage } from './settings.js';
...
export default {
  async fetch(request, env) {
    ...
    // R2_PUBLIC_URL w .dev.vars wskazuje na ten wlasnie adres. Na produkcji
    // ta galaz nigdy nie jest trafiana: R2_PUBLIC_URL wskazuje na prawdziwy
    // publiczny adres bucketu, nie na ten worker.
    const url = new URL(request.url);
